...
HD_PWD='C:/Users/linichol/finalproj/finalproj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fish_proj_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fish_proj_top.tcl -notrace
