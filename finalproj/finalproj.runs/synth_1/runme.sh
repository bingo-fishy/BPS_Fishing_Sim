...
HD_PWD='C:/Users/linichol/finalproj/finalproj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fish_proj_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fish_proj_top.tcl
